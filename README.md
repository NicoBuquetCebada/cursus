# <img width="27" height="27" src="https://raw.githubusercontent.com/kube/vscode-42header/master/42.png"> Cursus

Este repositorio contiene los proyectos desarrollados durante el **cursus de 42**, el programa principal de formación en de la red 42.

El cursus se basa en un modelo de aprendizaje práctico en el que los estudiantes construyen progresivamente una base sólida en programación, sistemas, algoritmos y desarrollo de software a través de proyectos reales, evaluación entre estudiantes y aprendizaje autónomo.

## ¿Qué es el cursus?

Es el programa central de formación de 42.

Se realiza después de la [**piscina**](https://github.com/NicoBuquetCebada/piscine) y consiste en un recorrido estructurado de proyectos progresivamente más complejos diseñados para desarrollar habilidades avanzadas de programación y resolución de problemas.

El modelo de aprendizaje se basa en:

- **Aprendizaje basado en proyectos**
- **Evaluación entre estudiantes (peer-to-peer)**
- **Resolución autónoma de problemas**
- **Colaboración entre estudiantes**
- **Desafíos de programación cercanos al mundo real**

El cursus está organizado en **milestones**, que representan diferentes etapas de aprendizaje.  
Cada milestone incluye varios proyectos centrados en habilidades técnicas específicas.

## Proyectos

Este repositorio está organizado según los milestones del cursus:
...
## Habilidades desarrolladas durante el cursus

A través de estos proyectos se desarrollan conocimientos prácticos en:
...
>El cursus enfatiza la escritura de **código robusto, eficiente y mantenible**, trabajando además bajo estándares estrictos de estilo.

***
# <img width="27" height="27" src="https://raw.githubusercontent.com/kube/vscode-42header/master/42.png"> Cursus

This repository contains the projects developed during the **42 cursus**, the main training program of the 42 network.

The cursus is based on a hands-on learning model in which students progressively build a strong foundation in programming, systems, algorithms, and software development through real projects, peer evaluation, and autonomous learning.

## What is the cursus?

It is the core training program of 42.

It takes place after the [**Piscine**](https://github.com/NicoBuquetCebada/piscine) and consists of a structured path of increasingly complex projects designed to develop advanced programming and problem-solving skills.
...
The cursus is organized into **milestones**, which represent different stages of learning.  
Each milestone includes several projects focused on specific technical skills.

## Projects

This repository is organized according to the cursus milestones:
...
## Skills developed during the cursus

Through these projects, practical knowledge is developed in:
...
>The cursus emphasizes writing **robust, efficient, and maintainable code**, while working under strict coding style standards.